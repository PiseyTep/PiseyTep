...
class _ButtonExampleState extends State<ButtonExample> {
  List<bool> isSelect = [false, false, false, false];  // List to keep track of button states
            ...
            return SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: isSelect[index] ? Colors.blue[500] : Colors.blue[50],
                  foregroundColor: isSelect[index] ? Colors.white : Colors.black,
                ),
